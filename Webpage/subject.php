...
<html>
<head>
	<title>Subject || Student Cell</title>
	<meta charset="utf-8">
	...
	<div id="subjectPart">
		<div class="container">
			<div class="well well-sm">
				<a href="home.php">Home</a> // <a href="mark.php">Exam Wise</a> // Subject Wise /
			</div>
			<div class="student-mark">
				<h1>Subject Wise Mark Details </h1>
				<?php
				session_start();
				...
				if ($_SESSION['username']) {
					...
					// $year = $_GET['year'];
					// $query = "SELECT * FROM student_mark WHERE student_name = '$username' AND year = '$year'";
