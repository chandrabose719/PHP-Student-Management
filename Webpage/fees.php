	...
	<div id="feePart">
		<div class="container">
			<div class="well well-sm">
				<a href="home.php">Home</a> // Fee Details /
			</div>
			<div class="student-mark">
				...
				// if ($_SESSION['username']) {
					...
					// $query = "SELECT * FROM student_fees WHERE student_name = '$username'";
					$query = "SELECT * FROM student_fees WHERE student_name = 'Bose'";
					$res = mysql_query($query);
					if (!$res) {
						echo "<script> alert 'There is NO Data for User!'</script>";
						echo "<div class='well well-sm'>
							Student Does Not Have Any Fee</div>";
					}else{
						echo "<div class='view-table'><table class='table table-striped table-bordered table-hover'>";
						echo "<tr><th>Fees Structure </th><th>Amount</th></tr>";
						while ($row=mysql_fetch_array($res)) {
							echo "<tr><td>Year :</td><td>" .$row['year']. "</td></tr>";
							echo "<tr><td>Student Name :</td><td>" .$row['student_name']. "</td></tr>";
							echo "<tr><td>Exam Fees :</td><td>" .$row['exam_fees']. "</td></tr>";
							echo "<tr><td>Tution Fees :</td><td>" .$row['tution_fees']. "</td></tr>";
							echo "<tr><td>Lab Fees :</td><td>" .$row['lab_fees']. "</td></tr>";
							echo "<tr><td>Total Fees :</td><td>" .$row['fees_total']. "</td></tr>";
						}
						echo"</table></div>";	
					}
				// }
